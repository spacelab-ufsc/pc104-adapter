...
The hardware project is composed by two boards: top and bottom. Both PCB\nomenclature{\textbf{PCB}}{\textit{Printed Circuit Board.}}s were designed using KiCad v5.1.8-5 \cite{kicad}. Both boards have also the same size, shape and number os layers (4), and are vertically simetrical (same components, but in different sides of the board).
