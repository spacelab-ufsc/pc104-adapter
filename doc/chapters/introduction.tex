...
The PC-104 Adapter boards are intended to be used in 2 or 3U CubeSat structures as an interconnection of two PC-104 bus segments. This interconnection is made with a PC-104 connector stack between the top and bottom boards. The set of two boards (top and bottom) of the adapter can be seen in \autoref{fig:pc104-adapter}.
